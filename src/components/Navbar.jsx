...
const Navbar = () => {
  ...
  return (
    <div className='flex justify-between md:fixed  items-center w-full h-20 px-5 text-white bg-gray-400 overflow-x-hidden overflow-y-auto'>
      <h1 className='text-4xl font-signature ml-3'>KBL - Web Solutions</h1>
