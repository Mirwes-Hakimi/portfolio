...
//     <div
//   name="home" 
//   className="h-screen w-full bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900 overflow-x-hidden overflow-y-auto"
// >
//   <div className="max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row text-white">
//     <div className="flex flex-col justify-center h-full">
//       <h2 className="text-center font-signature text-4xl sm:text-4xl p-2">
//         KBL Web Solutions
//       </h2>
//       <p className="text-gray-300 text-2xl text-center py-4 max-w-md md:max-w-screen-lg">
//         We offer full-service website design. Our passion is designing and building beautiful websites and experiences that will increase your business.
//       </p>
//     </div>
//     <div>
//       <img
